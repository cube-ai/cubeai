...
export class UmmClient {
    ...
    get_deployments(args): Observable<HttpResponse<any>> {
        const body = {
    ...
    update_deployment_solution_info(args): Observable<HttpResponse<any>> {
        const body = {
    ...
    update_deployment_admin_info(args): Observable<HttpResponse<any>> {
        const body = {
    ...
    update_deployment_star_count(args): Observable<HttpResponse<any>> {
        const body = {
