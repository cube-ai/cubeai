...
class SolutionApiA(tornado.web.RequestHandler):
    ...
    async def post(self, *args, **kwargs):
        ...
        await solution_db.create_solution(solution)
    ...
    async def get(self, *args, **kwargs):
        ...
        if uuid is not None:
            result = await solution_db.get_solutions_by_uuid(uuid)
        ...
        if where != '':
            where = 'WHERE ' + where
        total_count, result = await solution_db.get_solutions(where, pageable)
        self.set_header('X-Total-Count', total_count)

        self.write(json.dumps(result))


class SolutionApiB(tornado.web.RequestHandler):
    ...
    async def put(self, attr, *args, **kwargs):
        ...
        solution = Solution()
        solution.__dict__ = await solution_db.get_solution_by_id(body.get('id'))
        ...
        if attr == 'baseinfo':
            ...
            await solution_db.update_solution_baseinfo(solution)
            self.set_status(201)
            self.finish()
            ...
            await solution_db.update_solution_name(solution)
            self.set_status(201)
            self.finish()
            ...
            await solution_db.update_solution_picture_url(solution)
            self.set_status(201)
            self.finish()
            ...
            if solution.active and not body.get('active'):
                ...
                if credit.credit < 20:
                    ...
                    await solution_db.update_solution_active(solution)
            ...
            await solution_db.update_solution_admininfo(solution)
            self.set_status(201)
            self.finish()
            ...
            await solution_db.update_solution_star_count(solution)
            self.set_status(201)
            self.finish()
            ...
            await solution_db.update_solution_comment_count(solution)
            self.set_status(201)
            self.finish()
            ...
            await solution_db.update_solution_view_count(solution)
            self.set_status(201)
            self.finish()
            ...
            await solution_db.update_solution_download_count(solution)
            self.set_status(201)
            self.finish()
    ...
    async def delete(self, id, *args, **kwargs):
        ...
        solution = Solution()
        solution.__dict__ = await solution_db.get_solution_by_id(id)
        ...
        await solution_db.delete_solution(solution.id)
