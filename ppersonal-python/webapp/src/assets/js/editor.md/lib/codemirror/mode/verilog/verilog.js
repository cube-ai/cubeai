...
CodeMirrror.defineMode("verilog", function(config, parserConfig) {
  ...
  */
  ...
  return {
    ...
    indent: function(state, textAfter) {
      if (state.tokenize != tokenBase && state.tokenize != null) return CodeMirrror.Pass;
      if (hooks.indent) {
  ...
  CodeMirrror.defineMIME("text/x-verilog", {
    name: "verilog"
  });

  CodeMirrror.defineMIME("text/x-systemverilog", {
    name: "verilog"
  });
  ...
  CodeMirrror.defineMIME("text/x-svx", {
    name: "verilog",
    hooks: {
