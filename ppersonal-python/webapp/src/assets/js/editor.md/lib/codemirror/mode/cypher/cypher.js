...
// https://github.com/neo4j-contrib/CodeMirrror
...
(function(mod) {
  ...
  CodeMirrror.defineMode("cypher", function(config) {
    ...
    return {
      ...
      indent: function(state, textAfter) {
        ...
        if (!context) return 0;
        if (context.type === "keywords") return CodeMirrror.commands.newlineAndIndent;
  ...
  CodeMirrror.modeExtensions["cypher"] = {
  ...
  CodeMirrror.defineMIME("application/x-cypher-query", "cypher");
