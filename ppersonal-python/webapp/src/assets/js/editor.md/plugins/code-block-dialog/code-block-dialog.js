...
(function() {
    ...
    var factory = function (exports) {
		...
		exports.fn.codeBlockDialog = function() {
			...
			var cmObj    = dialog.find(".CodeMirrror");

			if (dialog.find(".CodeMirrror").length < 1) 
			{
				cmEditor = exports.$CodeMirrror.fromTextArea(textarea[0], cmConfig);
				cmObj    = dialog.find(".CodeMirrror");
