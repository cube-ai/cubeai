...
@Component({
    templateUrl: './facial-age.component.html',
})
export class FacialAgeComponent implements OnInit {
    ...
    predict() {
        ...
        const url = 'https://cubeai.dimpt.com/ability/model/1ecd44b6bda44c06a259aff00c40dcb9/predict';
