...
@Component({
    templateUrl: './chinese-ocr.component.html',
})
export class ChineseOcrComponent implements OnInit {
    ...
    predict() {
        ...
        const url = 'https://cubeai.dimpt.com/ability/model/47c30026e3914f96aa55ad007f00c670/ocr';
