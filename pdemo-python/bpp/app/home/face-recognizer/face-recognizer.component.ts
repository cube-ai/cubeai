...
export class FaceRecognizerComponent implements OnInit {
    ...
    predict() {
        ...
        const url = 'https://cubeai.dimpt.com/ability/model/2b9c44ebbc754db2b196961a42bfaeea/predict';
    ...
    add_face() {
        const url = 'https://cubeai.dimpt.com/ability/model/2b9c44ebbc754db2b196961a42bfaeea/add_face';
