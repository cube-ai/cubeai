...
from app.globals.db_client import DataBaseClient
import logging
...
class Globals:
    def __init__(self):
        ...
        self.db = None
        self.cached_user_tokens = {}
        self.verify_code_font = ImageFont.truetype('app/fonts/FreeSansBoldOblique.ttf', size=25)
