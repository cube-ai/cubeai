...
import {SnackBarService, UserService} from '../../shared';
...
export class MessageEditComponent implements OnInit {
    ...
    onSend() {
        ...
        this.messageService.sendMulticast(messageDraft).subscribe();
        this.onClose();
    }
    ...
    addToReceiverList(value: string): void {
        if ((value || '').trim()) {
            ...
            this.userService.getLoginExist(receiver).subscribe(
                (res) => {
                    if (res.body) {
