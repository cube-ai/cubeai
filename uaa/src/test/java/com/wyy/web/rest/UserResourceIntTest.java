...
import com.wyy.service.mapper.UserMapper;
...
public class UserResourceIntTest {
    ...
    private static final String DEFAULT_FULLNAME = "john";
    private static final String UPDATED_FULLNAME = "jhipsterFullName";

    private static final String DEFAULT_PHONE = "doe";
    private static final String UPDATED_PHONE = "jhipsterPhone";
    ...
    public void updateUserExistingEmail() throws Exception {
        ...
        anotherUser.setFullName("java");
        anotherUser.setPhone("hipster");
    ...
    public void testUserDTOtoUser() {
        ...
        assertThat(user.getPhone()).isEqualTo(DEFAULT_PHONE);
    ...
    public void testUserToUserDTO() {
        ...
        assertThat(userDTO.getPhone()).isEqualTo(DEFAULT_PHONE);
