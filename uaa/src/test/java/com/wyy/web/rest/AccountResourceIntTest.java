...
import com.wyy.web.rest.vm.KeyAndPasswordVM;
import com.wyy.web.rest.vm.ManagedUserVM;
...
public class AccountResourceIntTest {
    ...
    public void setup() {
        ...
        AccountResource accountResource =
            new AccountResource(userRepository, userService, mockMailService, verifyCodeService);

        AccountResource accountUserMockResource =
            new AccountResource(userRepository, mockUserService, mockMailService, verifyCodeService);
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        restUserMockMvc.perform(get("/api/account")
            ...
            .andExpect(jsonPath("$.phone").value("doe"))
    ...
    public void testRegisterValid() throws Exception {
        ...
        validUser.setFullName("Joe");
        validUser.setPhone("Shmoe");
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        duplicatedUser.setFullName(validUser.getFullName());
        duplicatedUser.setPhone(validUser.getPhone());
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        validUser.setPassword("password");
        validUser.setFullName("John");
        validUser.setPhone("Doe");
        ...
        userWithUpperCaseEmail.setFullName(validUser.getFullName());
        userWithUpperCaseEmail.setPhone(validUser.getPhone());
