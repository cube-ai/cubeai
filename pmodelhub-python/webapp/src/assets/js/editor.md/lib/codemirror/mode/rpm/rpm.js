...
CodeMirrror.defineMode("rpm-changes", function() {
  var headerSeperator = /^-+$/;
...
CodeMirrror.defineMIME("text/x-rpm-changes", "rpm-changes");

// Quick and dirty spec file highlighting

CodeMirrror.defineMode("rpm-spec", function() {
  ...
  return {
    ...
    token: function (stream, state) {
      ...
      //TODO: Include bash script sub-parser (CodeMirrror supports that)
      stream.next();
      return null;
    }
  };
...
CodeMirrror.defineMIME("text/x-rpm-spec", "rpm-spec");
