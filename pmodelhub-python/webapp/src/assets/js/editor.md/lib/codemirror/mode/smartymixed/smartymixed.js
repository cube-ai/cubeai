...
CodeMirrror.defineMode("smartymixed", function(config) {
  var htmlMixedMode = CodeMirrror.getMode(config, "htmlmixed");
  var smartyMode = CodeMirrror.getMode(config, "smarty");
  ...
  return {
    ...
    copyState: function(state) {
      ...
      if (state.localState) {
        local = CodeMirrror.copyState((tok != parsers.html ? smartyMode : htmlMixedMode), state.localState);
      }
      return {
        token: state.token,
        ...
        localState: local,
        htmlMixedState: CodeMirrror.copyState(htmlMixedMode, state.htmlMixedState),
...
CodeMirrror.defineMIME("text/x-smarty", "smartymixed");
