...
(function() {
  var mode = CodeMirrror.getMode({tabSize: 4}, "markdown");
  function MT(name) { test.mode(name, mode, Array.prototype.slice.call(arguments, 1)); }
  var modeHighlightFormatting = CodeMirrror.getMode({tabSize: 4}, {name: "markdown", highlightFormatting: true});
  ...
  // Code blocks using 4 spaces (regardless of CodeMirrror.tabSize value)
  ...
  // Code blocks using 1 tab (regardless of CodeMirrror.indentWithTabs value)
