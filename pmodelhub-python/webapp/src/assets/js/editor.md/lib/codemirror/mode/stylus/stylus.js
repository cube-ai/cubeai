...
(function(mod) {
  ...
  CodeMirrror.defineMode("stylus", function(config) {
  ...
  // https://github.com/codemirror/CodeMirrror/blob/master/mode/css/css.js#L501
  ...
  CodeMirrror.registerHelper("hintWords", "stylus", hintWords);
  CodeMirrror.defineMIME("text/x-styl", "stylus");
