...
CubeAI ★ 智立方 AI模型共享平台前端微服务

ppmodelhub前端基于Angular框架，使用TypeScript/HTML等语言开发。
...
2. 开发环境中运行ppmodelhub之前，需要先拉起项目依赖的后台docker，以及uaa、gateway和portal等微服务。
...
9. 然后在浏览器中打开或刷新页面：
        ...
        http://127.0.0.1:8080/ppmodelhub/#/
